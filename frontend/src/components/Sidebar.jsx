...
const Sidebar = ({ collapsed, onToggleSidebar }) => {
  ...
  const handleLogout = async (e) => {
    ...
    if (onToggleSidebar && window.innerWidth <= 992) {
      onToggleSidebar();
    }
      ...
      <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
        ...
        <div className="sidebar-footer">
          <button 
            ...
            title="Log Out"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
            <span>Log Out</span>
          </button>
        </div>
      </aside>
